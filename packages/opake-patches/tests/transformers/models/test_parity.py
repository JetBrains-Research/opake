...
from opake.api.patches.transformers import supported_families
...
def _get_families():
    ...
    with contextlib.suppress(Exception):
        from opake.api.patches.transformers.models import (  # noqa: F401
...
def test_lora_forward_parity(family, device):
    ...
    Gradient parity through LoRA weights is not tested here: the opake patches
