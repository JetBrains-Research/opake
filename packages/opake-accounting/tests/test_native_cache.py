"""Tests for :mod:`opake.api.accounting.core._native_cache`."""
...
from opake.api.accounting.core._native_cache import (
    NativeCache,
...
def test_env_override() -> None:
    env_name = "OPAKE_NATIVE_CACHE_TEST_CAP_BYTES"
...
def test_env_disable_with_zero() -> None:
    env_name = "OPAKE_NATIVE_CACHE_TEST_ZERO"
    old = os.environ.get(env_name)
    try:
