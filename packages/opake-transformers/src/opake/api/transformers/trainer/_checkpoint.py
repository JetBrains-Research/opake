...
:func:`opake.serialization.state_dict`; resume merges them with the live
training context via :func:`opake.serialization.from_state_dict`.
"""
...
from opake.types import ClipState, NoiseState
...
# Version 8 requires the current DP runtime state format.
...
def save_dp_runtime_state(  # noqa: PLR0913
    ...
    *,
    ...
    bundle = RuntimeCheckpoint(
        ...
        clip_state=opake_state_dict(clip_state),
        noise_state=opake_state_dict(noise_state),
...
def load_dp_runtime_state(path: str) -> RuntimeCheckpoint:
    ...
    into live objects with :func:`opake.serialization.from_state_dict` using
