...
def wrap_reporting_callback_class(callback_cls: type[Any]) -> type[Any]:
    ...
    if class_name == "WandbCallback":
        ...
        class OpakeWandbCallback(callback_cls):  # type: ignore[misc, valid-type]
        ...
        OpakeWandbCallback.__name__ = "OpakeWandbCallback"
        wrapped = OpakeWandbCallback
    elif class_name == "TensorBoardCallback":

        class OpakeTensorBoardCallback(callback_cls):  # type: ignore[misc, valid-type]
        ...
        OpakeTensorBoardCallback.__name__ = "OpakeTensorBoardCallback"
        wrapped = OpakeTensorBoardCallback
    else:
...
class BestModelSaveCallback(TrainerCallback):
    ...
    Auto-injected by :class:`Trainer` when ``save_strategy == "best"`` or
