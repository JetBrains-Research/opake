"""Cross-validation: opake.accounting vs dp_accounting + riskcal.

These tests verify numerical agreement between opake's Rust-backed PLD
...
Run selectively with::
    ...
    uv run --group cross-validation pytest packages/opake-dpsgd/tests/accounting/test_cross_validation.py -v
"""
...
import opake.accounting as acc  # noqa: E402
...
# convolutions.
import opake.dpsgd.accounting as dpsgd_acc  # noqa: E402
from opake.accounting import calibration as cal  # noqa: E402
from opake.api.accounting.core.discretization import get_discretization  # noqa: E402
...
# NOTE: opake and dp_accounting agree to ~1e-9 relative error.
...
class TestGaussianEpsilon:
    """Single Gaussian mechanism: opake vs dp_accounting epsilon_at."""
...
class TestGaussianDelta:
    """Single Gaussian mechanism: opake vs dp_accounting delta_at."""
...
class TestPoissonEpsilon:
    ...
    # Grid spans the regimes that matter for the opake-vs-dp_accounting
...
# ============================================================================
# 3. Triple validation: opake vs dp_accounting vs riskcal
# ============================================================================
...
class TestTripleRisk:
    """Bayes risk: opake vs riskcal.get_bayes_risk_from_pld."""
...
class TestAdaClipCrossValidation:
    ...
    def test_adaclip_effective_noise(self, sigma, batch_size):
        ...
        from opake.dpsgd.accounting.mechanisms.types import AdaClip
