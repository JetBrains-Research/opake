...
:class:`~opake.api.transformers.trainer._training_arguments.TrainingArguments`. Fields with
...
class SFTConfig(TrainingArguments):
    ...
    #: Opake-specific (no TRL analogue): enable the model-level Triton kernels
    ...
    def from_trl(
        ...
        **opake_overrides: Any,
        ...
        """Convert a ``trl.SFTConfig`` to an opake ``SFTConfig``.
        ...
        ``per_device * gradient_accumulation_steps`` → opake logical
        batch collapse.
