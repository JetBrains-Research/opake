...
from opake.api.auditing.one_run._eps_delta import _p_value as _eps_delta_p_value
from opake.api.auditing.one_run._gdp import (
    GdpMethod,
...
from opake.auditing import one_run
from opake.auditing.types import CanaryScores, CoinFlip

gdp_module = importlib.import_module("opake.api.auditing.one_run._gdp")
