...
adaptive clipping sync lives in :mod:`opake.dpsgd.clipping.distributed`
and self-registers via :func:`opake.distributed.register_sync_type`.
"""
...
from opake.api.engine.distributed import is_distributed
...
from opake.exceptions import InputTypeError, OperationError
...
def sync_clip_state(
    ...
    :mod:`opake.dpsgd.clipping.distributed`.
    """
...
def _gather_aux_fields(tensor_fields: dict[str, object]) -> dict[str, object]:
    ...
    :func:`~opake.pytree.tree_flatten` / cat /
    :func:`~opake.pytree.tree_unflatten`.
    """
