"""Tests for opake.distributed core utilities.
...
from opake.api.engine.distributed.gradients import (
    _assert_public_metadata_equal,
)
from opake.api.engine.distributed.gradients import (
    _reduced_metadata as _reduced_metadata,
)
from opake.distributed import get_rank, get_world_size, is_distributed, sum_gradients
from opake.distributed.collectives import all_reduce, all_reduce_, barrier
from opake.distributed.gradients import (  # noqa: F401
    reduce_pytree,
    reduce_pytree_,
    sum_gradients_,
)
...
class TestSyncObjectSchema:
    ...
    def test_callable_cannot_replace_boolean_field(self, monkeypatch):
        import opake.api.engine.distributed._state as state_module
...
class TestDistributedMetadataValidation:
    ...
    def _record_metadata_calls(monkeypatch):
        import opake.api.engine.distributed.gradients as gradients_module
