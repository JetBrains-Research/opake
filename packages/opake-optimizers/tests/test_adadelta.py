"""Tests for opake.optimizers._adadelta — Adadelta with two-EMA DP BC.
...
The opake-built variant maintains two parallel φ-EMAs at the same
...
from opake.optimizers import adadelta
from opake.optimizers.types import AdadeltaState
