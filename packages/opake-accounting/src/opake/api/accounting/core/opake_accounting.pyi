"""Type stubs for the ``opake.accounting`` Rust extension module.

``opake.accounting`` provides flat PLD-based privacy accounting.
...
class DiscretizationConfig:
    ...
    Args:
        ...
        seed: RNG seed for reproducibility across worker counts within a fixed
            Opake and dependency build. Exact streams may change across
            releases. Default: 42.
