...
class TinyConfig(PretrainedConfig):
    ...
    # It is intentionally not part of opake's production patch registry.
    model_type = "tiny_dp"
...
def scenario_push_to_hub_no_deadlock(
    ...
    with (
        mock_patch(
            "opake.api.transformers.trainer._hub._create_repo",
            return_value=mock_repo_url,
        ),
        mock_patch(
            "opake.api.transformers.trainer._hub._upload_folder",
