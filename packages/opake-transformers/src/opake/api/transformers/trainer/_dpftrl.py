...
:func:`opake.dpftrl.noise.mf_gaussian_noise` and accounts that process once.
"""
...
def build_strategy(
    ...
    from :mod:`opake.scheduling` round-trip cleanly through the
...
def build_sampler(
    *,
    ...
    """Construct the Opake sampler matching ``sampling_mode``.
