...
:func:`opake.dpsgd.accounting.poisson` passing both
...
:mod:`opake.serialization` (done at module-import time below) so
...
POISSON_STREAM_FOLD = "opake.dpsgd.poisson"
...
class PoissonSampler(Sampler):
    ...
    Args:
        ...
        sample_rate: Probability of including each example ``∈ (0, 1]``.
            ...
            account the step with :func:`opake.dpsgd.accounting.gaussian`.
    ...
    Note:
        ...
        - Resume via :func:`opake.serialization.state_dict` /
          :func:`opake.serialization.from_state_dict`: state captures the
