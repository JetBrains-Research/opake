...
# handling and adapted to Opake's vmap-friendly new-style autograd dispatch.
...
support our standard Opake_Foo + _FooBackward vmap dispatch pattern.
...
class Opake_LinearCrossEntropyLoss(torch.autograd.Function):
...
def opake_linear_cross_entropy_loss(
    ...
    ensure_cuda_tensors(
        ...
        weight,
        labels,
        fn_name="opake_linear_cross_entropy_loss",
    )
