...
from opake.api.transformers.trainer._trainer import Trainer
...
class TestDpFtrlSamplerDispatch:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("mf_identity", "opake.api.dpsgd.sampling._poisson"),
            ("mf_band", "opake.api.dpftrl.sampling._poisson"),
            ("mf_blt", "opake.api.dpftrl.sampling._balls_in_bins"),
            ("mf_bisr", "opake.api.dpftrl.sampling._balls_in_bins"),
            ("mf_bsr", "opake.api.dpftrl.sampling._balls_in_bins"),
            ("mf_lambda_cgd", "opake.api.dpftrl.sampling._balls_in_bins"),
        ],
    )
...
class TestDpFtrlCheckpointRoundTrip:
    ...
    def test_k_out_of_t_resume_rejects_parameter_drift(
        ...
        from opake.api.transformers.trainer import _checkpoint as ckpt
...
class TestDpFtrlLrScheduleIntegration:
    ...
    Pre-refactor (opake.scheduling as a closure DSL), the trainer
    ...
    def test_band_mf_strategy_receives_schedule(self, tmp_path):
        ...
        from opake.scheduling.types import ConstantSchedule, CosineSchedule
