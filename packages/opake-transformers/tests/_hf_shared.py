"""Shared helpers for opake-transformers validation + distributed tests.
...
which calls ``opake.patches.apply_runtime_patches(compat=True)`` so global HF
...
import torch
from opake_test_support import get_default_gpu_device
...
def run_dp_training_step(
    ...
    Returns:
        ...
        :class:`~opake.types.ClippedPytree` for the last training step
