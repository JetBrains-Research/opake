...
from opake.api.engine.clipping._clipped_fun import FixedClipState, clipped_fun
...
from opake.api.engine.functional._transform_stack import (
    under_differentiating_transform,
)
from opake.api.engine.pytree import tree_map
from opake.api.engine.types import PerGroup, clipped
...
def clipped_grad(
    ...
    *,
    ...
    def _empty_batch_response(args, state):
        ...
        if second_moment:
            from opake.api.engine.types import SecondMomentClippingOutput
        ...
        if return_stats:
            from opake.api.engine.clipping._clipped_fun import ClippingStats
    ...
    if return_stats:
        ...
        def grad_fn_wrapper(*args, state, **kwargs):
            ...
            with record_function("opake::clipped_grad"):
